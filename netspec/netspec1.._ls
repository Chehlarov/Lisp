...
;;;;;;;;;;;;;;;;;;;;;;;
		...
		(setq kol
		       (subst
			 (cons 'ST10
			       (+ (* n L B 0.00001) (cdr (assoc 'ST10 kol)))
			 )
			 (assoc 'ST10 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST20
			       (+ (* n L B 0.00001) (cdr (assoc 'ST20 kol)))
			 )
			 (assoc 'ST20 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST25
			       (+ (* n L B 0.00001) (cdr (assoc 'ST25 kol)))
			 )
			 (assoc 'ST25 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST30
			       (+ (* n L B 0.00001) (cdr (assoc 'ST30 kol)))
			 )
			 (assoc 'ST30 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST35
			       (+ (* n L B 0.00001) (cdr (assoc 'ST35 kol)))
			 )
			 (assoc 'ST35 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST50
			       (+ (* n L B 0.00001) (cdr (assoc 'ST50 kol)))
			 )
			 (assoc 'ST50 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST60
			       (+ (* n L B 0.00001) (cdr (assoc 'ST60 kol)))
			 )
			 (assoc 'ST60 kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST15C
			       (+ (* n L B 0.00001) (cdr (assoc 'ST15C kol)))
			 )
			 (assoc 'ST15C kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST25C
			       (+ (* n L B 0.00001) (cdr (assoc 'ST25C kol)))
			 )
			 (assoc 'ST25C kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST25CS
			       (+ (* n L B 0.00001) (cdr (assoc 'ST25CS kol)))
			 )
			 (assoc 'ST25CS kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST40C
			       (+ (* n L B 0.00001) (cdr (assoc 'ST40C kol)))
			 )
			 (assoc 'ST40C kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST50C
			       (+ (* n L B 0.00001) (cdr (assoc 'ST50C kol)))
			 )
			 (assoc 'ST50C kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'ST65C
			       (+ (* n L B 0.00001) (cdr (assoc 'ST65C kol)))
			 )
			 (assoc 'ST65C kol)
			 kol
		       )
		...
		(setq kol
		       (subst
			 (cons 'RAFV
			       (+ (* n L B 0.001) (cdr (assoc 'RAFV kol)))
			 )
			 (assoc 'RAFV kol)
			 kol
		       )
